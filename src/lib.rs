...
#[derive(Debug)]
pub struct KuberDeployProcessor {
    verbose: bool,
    processed_count: usize,
}

impl KuberDeployProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting KuberDeploy processing");
    
    let mut processor = KuberDeployProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = KuberDeployProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = KuberDeployProcessor::new(false);
